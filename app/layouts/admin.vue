    ...
    <div class="flex gap-x-1">
      ...
      >
        ...
        <div class="navigation-menu flex-1 space-y-4 pr-6 pl-8">
          <NuxtLink
            to="/admin/home"
            class="hover:text-primary-700 dark:hover:text-primary-200 mt-4 flex items-center gap-x-2 rounded-lg p-2 font-medium transition duration-200"
      ...
      <!-- Mobile -->
      <nav
        class="border-surface-300 dark:bg-surface-800/80 fixed top-0 z-20 h-14 w-full bg-white/80 px-4 py-2.5 backdrop-blur-sm transition lg:hidden dark:border-neutral-700"
      >
      ...
      <div
        class="dark:bg-surface-800 w-full min-h-screen lg:min-h-auto rounded-xl bg-white px-6 pt-16 lg:my-2.5 lg:mr-2.5 lg:pt-6 lg:pr-6"
      >
