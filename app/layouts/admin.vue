<template>
  <div
    class="lg:bg-cics-white min-h-screen dark:bg-neutral-900 lg:dark:bg-neutral-800"
  >
    <div class="flex gap-x-1">
      <!-- Desktop -->
      <nav
        class="bg-cics-white hidden w-[22rem] shrink-0 flex-col self-start py-5 lg:sticky lg:top-0 lg:flex lg:h-screen dark:bg-neutral-800"
      >
        <h4
        ...
        <div class="navigation-menu flex-1 space-y-4 pr-6 pl-8">
          <NuxtLink
            to="/admin/home"
            class="hover:text-primary-700 dark:hover:text-primary-200 mt-4 flex items-center gap-x-2 rounded-lg p-2 font-medium transition duration-200 dark:bg-neutral-800"
      ...
      <!-- Mobile -->
      <nav
        class="border-surface-300 dark:bg-surface-900/80 fixed top-0 z-20 h-14 w-full bg-white/80 px-4 py-2.5 backdrop-blur-sm transition lg:hidden dark:border-neutral-700"
      >
      ...
      <div
        class="w-full rounded-xl bg-white px-6 pt-16 lg:my-2.5 lg:mr-2.5 lg:pt-6 lg:pr-6 dark:bg-neutral-900"
      >
...
.menu-item {
  @apply text-muted-color-emphasis hover:text-primary-700 hover:before:bg-primary-700 dark:hover:text-primary-300 hover:before:dark:bg-primary-200 relative flex items-center gap-x-2 rounded-lg py-2 pr-2 pl-8 font-medium outline outline-transparent transition-all duration-200 dark:bg-neutral-800;
  &::before {
    @apply absolute top-1/2 left-4 h-[calc(100%+4px)] w-0.5 -translate-y-1/2 bg-gray-300 dark:bg-neutral-700;
    content: '';
...
.active-menu {
  @apply text-primary-700 focus:text-primary-500 active:text-primary-500 dark:text-primary-500 z-50 shadow-md outline-1 outline-gray-600 dark:outline-neutral-600;
  &::before {
