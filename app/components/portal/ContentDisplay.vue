<template>
  <div class="relative flex flex-col items-start gap-4 lg:flex-row lg:gap-12">
      ...
      <div class="max-h-96 overflow-y-auto">
        ...
        >
          ...
          >
            ...
            size="12"
            class="mb-1 mr-1 inline text-muted-foreground"
            /> -->
    ...
    <Popover>
      ...
      >
        <Icon
          ...
          class="text-muted-foreground mr-2 mb-1 inline"
        />
        En esta página
      </PopoverTrigger>
      <PopoverContent
        ...
        <div class="max-h-80 overflow-y-auto">
          ...
          >
            <li
              ...
              class="hover:text-primary-600 dark:hover:text-primary-300 text-sm"
            >
              <NuxtLink :to="`#${link.id}`" class="toc-item">
                {{ link.text }}
              </NuxtLink>
            </li>
          </ul>
    ...
    <h1 class="text-muted-foreground hidden italic print:block">
...
.toc-item {
  @apply text-muted-foreground relative flex items-center rounded-lg py-px pr-2 pl-4 font-medium transition-all duration-200 before:absolute before:top-1/2 before:-left-0.5 before:h-full before:w-0.5 before:-translate-y-1/2 before:rounded-full before:bg-transparent hover:text-black hover:before:bg-black dark:bg-transparent before:dark:bg-neutral-700 dark:hover:text-white dark:hover:before:bg-white;
