<template>
  <table class="border-separate border-spacing-0">
    <thead class=" sticky top-14 z-10">
      <tr class="">
        <th class=""></th>
        <th v-for="classroom in classrooms" :key="classroom.id" class="px-3 py-1 bg-clip-padding bg-white border min-w-32">
          <div class="text-left  ">
    ...
    <tbody>
      <tr v-for="hour in hours" :key="hour.id">
        <th class="font-medium text-sm p-2 sticky border left-0 z-10 bg-white">
